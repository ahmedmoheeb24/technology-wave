        ...
        <>
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 transition-all duration-300 ${isScroll 
                ...
                <ul className='hidden md:flex items-center gap-3 lg:gap-8 xl:gap-10'>
                    {navLinks.map((link) => (
                        <li key={link.href}>
                            <a className='font-Ovo text-sm lg:text-base relative group whitespace-nowrap text-gray-700 hover:text-blue-600 transition-colors' href={link.href}>
                                {link.label}
                ...
                <div className='flex items-center gap-2 lg:gap-4'> 
                    ...
                    <a href="#contact" 
                        className='hidden lg:flex items-center gap-2 px-6 py-2.5 bg-blue-600 text-white rounded-full font-Ovo transition-all duration-300 hover:bg-blue-700 hover:-translate-y-1 hover:shadow-lg active:scale-95'> 
                        Contact Us
                    ...
                    <button 
                        className='block md:hidden ml-2 p-2 hover:bg-gray-100 rounded-lg transition-all' 
                        onClick={openMenu}
