    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {specialties.map((item, index) => (
              <motion.div
                ...
                className="bg-white rounded-xl p-5 border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all group cursor-default"
              >
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p className="text-blue-600 font-mono text-xs tracking-widest uppercase mb-3">What Drives Us</p>
            <h2 className="text-3xl sm:text-4xl font-black text-gray-900">Core Values</h2>
          </motion.div>
            ...
            {values.map((value, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-white rounded-2xl p-7 border border-gray-100 hover:border-blue-200 hover:shadow-xl transition-all duration-300"
                >
                  <div className={`w-12 h-12 rounded-2xl bg-gradient-to-r ${value.color} flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300`}>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p className="text-blue-600 font-mono text-xs tracking-widest uppercase mb-3">Two Decades</p>
            <h2 className="text-3xl sm:text-4xl font-black text-gray-900">Our Journey</h2>
          </motion.div>

          <div className="relative">
            <div className="absolute left-4 sm:left-1/2 top-0 bottom-0 w-px bg-gray-100 sm:-translate-x-px" />
            ...
            <div className="space-y-6">
              {timeline.map((item, index) => (
                <motion.div
                  ...
                  className={`relative flex items-start sm:items-center gap-0 ${index % 2 === 0 ? 'sm:flex-row' : 'sm:flex-row-reverse'}`}
                >
                  {/* Dot */}
                  <div className="absolute left-4 sm:left-1/2 w-2.5 h-2.5 bg-blue-600 rounded-full border-2 border-white shadow-md sm:-translate-x-1/2 mt-5 sm:mt-0 z-10 ring-4 ring-blue-100" />

                  {/* Card */}
                  <div className={`ml-10 sm:ml-0 sm:w-[calc(50%-2.5rem)] ${index % 2 === 0 ? 'sm:pr-10' : 'sm:pl-10'}`}>
                    <div className="bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-lg hover:border-blue-100 transition-all">
