...
                        {(product.product_image || (typeof product.image === 'string' && product.image.startsWith('http'))) ? (
                          <div 
                            className="w-full h-full bg-cover bg-center transition-transform duration-500 group-hover:scale-110"
                            style={{ backgroundImage: `url(${product.product_image || product.image})` }}
                          />
                        ) : (
...
                          {/* Safety check for malformed titles and support for product_name */}
