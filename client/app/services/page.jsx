...
const services = [
  {
    ...
    // UPDATED: Filenames updated to match server renames
  ...
  },
  {
    ...
    heroImage: `${ASSET_URL}/military-division-1.jfif`,
    detailImage: `${ASSET_URL}/military-division-2.jfif`,
    sections: [
  ...
  },
  {
    ...
    heroImage: `${ASSET_URL}/helicopters-1.jfif`,
    detailImage: `${ASSET_URL}/helicopters-2.jfif`,
    sections: [],
              ...
              <Link href={`/services/${service.slug}`} className="h-full flex">
                <div className="relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 cursor-pointer flex flex-col w-full h-full">
                  ...
                  <div className="relative w-full h-48 overflow-hidden flex-shrink-0">
                    {/* UPDATED: Replaced Next.js Image with standard img for reliability */}
                    <img
